...
$n1->imagen = 'https://www.nasa.gov/sites/default/files/styles/full_width_feature/public/thumbnails/image/crs7-postlaunch1.jpg';
...
$n5 = new stdClass();
$n5->titulo = "Noticia nueva";
$n5->contenido = "Según el comunicado oficial 'debido a la crisis global que vive el sector, y la cantidad de pelotudos que ocupan mesas durante 8 horas con un café y dos mediaslunas solamente para darse corte que tienen una MacBook, se hace inviables la continidad de las operaciones en Argentina.'";
...
$n6 = new stdClass();
$n6->titulo = "Noticia nueva 2";
$n6->contenido = "Según el comunicado oficial 'debido a la crisis global que vive el sector, y la cantidad de pelotudos que ocupan mesas durante 8 horas con un café y dos mediaslunas solamente para darse corte que tienen una MacBook, se hace inviables la continidad de las operaciones en Argentina.'";
$n6->imagen = "https://1.bp.blogspot.com/-HiD_vBlSbg0/X2PjR8udR5I/AAAAAAAAIvw/E3EWAortz7A3ZHIdTrOGHa7YGsf17ZUiQCLcBGAsYHQ/w640-h444/starbucks.jpg";

$noticias = [$n1, $n2, $n3, $n4, $n5,  $n6];